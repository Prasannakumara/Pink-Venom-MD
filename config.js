...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PINKVENOM-MD;SAdnDbJB#NaRqFtEkHE5NeThjO3uutVu0JteE0MAnOEvhNSfah9s : process.env.SESSION_ID, //ADD YOUR SESSION ID
    GITHUB_USER_NAME: process.env.GITHUB_USER_NAME === undefined ? 'prasanna no' : process.env.GITHUB_USER_NAME, //ADD YOUR GITHUB USERNAME
    ...
    OWNER: process.env.OWNER === undefined ? `94767308017` : process.env.OWNER, //BOTS OWNER NUMBER
